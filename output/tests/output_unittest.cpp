...
#define EVENT3UPDATEFILE "event2update.txt"
...
class OutputTest : public ::testing::Test {
 protected:
	virtual void SetUp() {
		...
		// logger::log_init("outputtest", spdlog::level::debug, true, testpath);

		// create input test
		OutputThread = new glass::output();
		OutputConfig = NULL;
		...
		event2updatefile = inputdirectory + "/" + std::string(EVENT3UPDATEFILE);
...
TEST_F(OutputTest, Update) {
	...
	// get the data
	json::Object * senthypo2 = GetDataFromFile(hypo2updatefile);
