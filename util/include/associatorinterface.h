...
/**
 * \namespace glass3
 * \brief The neic-glass3 project  namespace containing all the classes and
 * functions that make up neic-glass3
 *
 ...
 * \brief The neic-glass3 project namespace containing utility classes and
 * functions
 *
